...
import com.rs.webrtc_apm.R;


public class WebrtcAPMActivity extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, Counters {
...
//        AudioProcessingConfig.Builder configBuilder = new AudioProcessingConfig.Builder()
//                .setEchoCanceller(true)  // 启用 AEC
//                .setNoiseSuppressionLevel(AudioProcessingConfig.NoiseSuppressionLevel.HIGH);  // 设置噪声抑制级别
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.cbSpeechIntelligibilityEnhance) {
